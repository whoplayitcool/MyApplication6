...
import cn.bxw1.bxapp.adapter.CategorizeProductAdapter;
import cn.bxw1.bxapp.config.Config;
...
//        ButterKnife.bind(this, view);
        ...
        tools_scrollView = (ScrollView) view.findViewById(R.id.tools_scrollView);
    ...
    private void initViewPager() {
        ...
        Log.e("TAG", "分类适配器是"+categorizeProductAdapter.toString());
