 ...
 */
public class ALoginActivity extends Activity implements OnClickListener{
	private Toast mToast;
	
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
//		requestWindowFeature(Window.FEATRE_NO_TITLE);
		setContentView(R.layout.activity_alogin);
	
		findViewById(R.id.btn_confirm).setOnClickListener(ALoginActivity.this);
		mToast = Toast.makeText(ALoginActivity.this, "", Toast.LENGTH_SHORT);
	}
	...
	public void onClick(View v) {
		...
		case R.id.btn_confirm:
			...
			Intent intent = new Intent(ALoginActivity.this, IsvDemo.class);
